...
const Header = () => {
  ...
  window.googleTranslateElementInit = () => {
    const tryInit = (retries = 0) => {
      const hasGoogle = window.google && window.google.translate && typeof window.google.translate.TranslateElement === "function";
      ...
      if (hasGoogle) {
        ...
        // intenta hasta 20 veces (10 segundos total)
        setTimeout(() => tryInit(retries + 1), 500);
      } else {
        console.warn("⚠️ Google Translate no se inicializó correctamente.");
      }
    };
